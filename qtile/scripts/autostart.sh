...
# set background
$HOME/.config/qtile/scripts/.fehbg
...
# change caps_lock with ctrl and disable capslock
...
xinput set-prop "USB GAMING MOUSE " 319 -1 &
...
# spotify adblocker call
# AUTO START APPLICATOIN
#discord &
