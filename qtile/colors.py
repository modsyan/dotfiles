...
def nord():
    ...
    # add by me the oginal one is up
	workspaceColor = colors[4]
...
def arcoLinux():
    colors = [["#1F343F", "#2F343F"], # color 0
               ["#1F343F", "#2343F"], # color 1
               ["#191413", "#191414"], # color 2
               ["#c1c5ce", "#c0c5ce"], # color 3
               ["#fba921", "#fba922"], # color 4
               ["#3383d0", "#3384d0"], # color 5
               ["#f2f4f5", "#f3f4f5"], # color 6
               ["#cd0f3f", "#cd1f3f"], # color 7
               ["#61FF00", "#62FF00"], # color 8
               ["#6789eb", "#6790eb"], # color 9
               ["#a8a9a9", "#a9a9a9"]] # color 10

    backgroundColor = "#1F343F"
    foregroundColor = "#c1c5ce"
